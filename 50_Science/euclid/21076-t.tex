...
$DCF$ is equal to the angle $ECF$, and they are adjacent %% corrected DEC to DCF
...
square on $CB$, is equal to the square on $CD$.} %% corrected "it equal" to "is equal"
...
Through $A$ draw $AK$ parallel %% corrected "draw AK parallel A to CL" to "draw AK parallel to CL"
to $CL$ [I.~\textsc{xxxi}.].
